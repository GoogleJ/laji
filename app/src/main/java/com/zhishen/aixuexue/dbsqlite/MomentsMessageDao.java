package com.zhishen.aixuexue.dbsqlite;
...
import com.zhishen.aixuexue.manager.DBManager;
...
public class MomentsMessageDao {
    ...
    public void sendMomentsCmd(String imageUrl, String momentsId, String content, int type, String sendTo){
        if(sendTo.equals(AiApp.getInstance().getUsername())){
            return;

        }
        JSONObject data=new JSONObject();
        data.put("userId", AiApp.getInstance().getUsername());
        data.put("nickname",AiApp.getInstance().getUserJson().getString(Constant.JSON_KEY_NICK));
        data.put("avatar",AiApp.getInstance().getUserJson().getString(Constant.JSON_KEY_AVATAR));
    ...
    public void sendMomentsNearByCmd(String imageUrl, String momentsId, String content, int type, String sendTo){
        if(sendTo.equals(AiApp.getInstance().getUsername())){
            return;
