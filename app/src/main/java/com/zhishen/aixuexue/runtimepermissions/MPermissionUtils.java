package com.zhishen.aixuexue.runtimepermissions;
...
public class MPermissionUtils {
     ...
     * 显示提示对话框
     */
    public static void showTipsDialog( Context context,  String text) {
        new AlertDialog.Builder(context)
                .setTitle("提示信息")
                .setMessage("当前应用缺少" + text + "权限，该功能暂时无法使用。如若需要，请单击【确定】按钮前往设置中心进行权限授权。")
