...
public class PreferenceManager {
    ...
    private static String HOME_NOTIFY_ISREAD = "notify_isread";
    ...
    public boolean isReadNotify(){
        return mSharedPreferences.getBoolean(HOME_NOTIFY_ISREAD, false);
    }
    public void setReadyNotify(boolean isRead){
        editor.putBoolean(HOME_NOTIFY_ISREAD, isRead).apply();
    }
