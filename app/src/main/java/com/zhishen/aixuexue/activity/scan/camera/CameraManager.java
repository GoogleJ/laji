 ...
 */
package com.zhishen.aixuexue.activity.scan.camera;
...
import com.zhishen.aixuexue.activity.scan.camera.open.OpenCamera;
import com.zhishen.aixuexue.activity.scan.camera.open.OpenCameraInterface;
...
//    private static final int MAX_FRAME_HEIGHT = 675; // = 5/8 * 1080
    ...
    public synchronized Rect getFramingRect() {
        if (framingRect == null) {
            ...
            framingRect = new Rect(leftOffset + width / 8, topOffset, leftOffset + width - width / 8, (int) (topOffset +  height * 0.75));
            Log.d(TAG, "Calculated framing rect: " + framingRect + width + "====" + height);
        }
