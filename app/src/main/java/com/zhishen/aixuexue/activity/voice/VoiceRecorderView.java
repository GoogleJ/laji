...
public class VoiceRecorderView extends RelativeLayout {
                ...
                if (event.getY() < 0) {
                     ...
                     try {
                        ...
                        if (length > 0) {
                            ...
                            CommonUtils.showToastShort(context, R.string.Recording_without_permission);
                        } else {
                            CommonUtils.showToastShort(context, R.string.The_recording_time_is_too_short);
                        }
                    } catch (Exception e) {
                        e.printStackTrace();
                         CommonUtils.showToastShort(context, R.string.send_failure_please);
                    }
                }
                return true;
            default:
    ...
    public void startRecording() {
        if (!CommonUtils.isSdcardExist()) {
            CommonUtils.showToastShort(context, R.string.Send_voice_need_sdcard_support);
            return;
        }
        try {
            wakeLock.acquire();
            ...
            CommonUtils.showToastShort(context, R.string.recoding_fail);
            return;
        }
    }
    ...
    public void showReleaseToCancelHint() {
        ...
        recordingHint.setBackgroundResource(R.color.font_gray_white);
    }
