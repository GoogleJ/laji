...
/**
 * Created by Jerome on 2018/7/9
 */
public class ListPopWindow extends PopupWindow implements View.OnClickListener {
    ...
    public void setOnItemClickListener(ListOnItemClickListener onItemClickListener) {
        this.onItemClickListener = onItemClickListener;
    }

    private void init(Context context) {
        LayoutInflater inflater = LayoutInflater.from(context);
        mView = inflater.inflate(R.layout.view_list_pop, null);
        TextView tvMan = mView.findViewById(R.id.tvMan);
        TextView tvWomen = mView.findViewById(R.id.tvWomen);
        setPopupWindow();
    ...
    public void onClick(View v) {
        if (onItemClickListener != null) {
            onItemClickListener.getListItemClick(v);
        }
    }

    public interface ListOnItemClickListener {

        void getListItemClick(View v);
    }
